...
public class CompatPacketRegistry {
    ...
    public void registerPacket(Identifier Identifier) {
        packets.computeIfAbsent(Identifier, CompatPacket::new);
    }

    public void registerNetworkReceiverS2C(Identifier Identifier, Consumer<FriendlyByteBuf> consumer) {
        packets.computeIfAbsent(Identifier, CompatPacket::new);
        packetsS2C.put(Identifier, consumer);
    }

    public void registerNetworkReceiverC2S(Identifier Identifier, ServerPlatform.C2SPacketHandler consumer) {
        packets.computeIfAbsent(Identifier, CompatPacket::new);
        packetsC2S.put(Identifier, consumer);
    }
