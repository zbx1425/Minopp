    ...
    private static void putAIPreferences(ConfigCategory.Builder builder, EntityAutoPlayer target) {
        OptionGroup aiOpts = OptionGroup.createBuilder()
                ...
                .option(Option.<Boolean>createBuilder()
                        ...
                        .binding(false, () -> target.autoPlayer.noWin, value -> target.autoPlayer.noWin = value)
                        .controller(opt -> BooleanControllerBuilder.create(opt).yesNoFormatter())
                        .build()
                )
                .option(Option.<Boolean>createBuilder()
                ...
                .option(Option.<Float>createBuilder()
                        ...
                        .binding(0.2f, () -> target.autoPlayer.forgetChance, value -> target.autoPlayer.forgetChance = value)
        ...
        OptionGroup aiMetaOpts = OptionGroup.createBuilder()
                ...
                .option(Option.<Integer>createBuilder()
                        ...
                        .binding(0, () -> (int) target.autoPlayer.noDelay, value -> target.autoPlayer.noDelay = (byte)(int) value)
